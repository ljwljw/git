...
//常见问题
	$(function(){
		//调用ajax    
		 var json = ajax('commonquestion');
		 //alert(json)
		var str = '';
		$.each(json,function(name,value){
			str += '<a href="javascript:void(0)"><li class="answer-list"><h3 class="list-tit">'+value['name']+'</h3><p class="list-txt">'+value['content']+'</p></li></a>';
		})
		$('#ul').html(str);
	})
	/*$(function(){
		$.ajax({
			    type : "get",
			    url : "http://www.wsc.com/shixun/jiekou/laravel/public/commonquestion",
			    dataType : "jsonp",
